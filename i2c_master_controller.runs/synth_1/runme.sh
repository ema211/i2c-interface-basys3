...
HD_PWD='D:/DSD/i2c_master_controller/i2c_master_controller.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_core_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_core_test.tcl
