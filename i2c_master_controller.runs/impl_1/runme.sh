...
HD_PWD='D:/DSD/i2c_master_controller/i2c_master_controller.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_core_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_core_test.tcl -notrace
